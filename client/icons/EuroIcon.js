...
const EuroIcon = ({classname}) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="#000000" height="800px" width="800px" version="1.1" id="Capa_1" viewBox="0 0 310.75 310.75" className={classname??"w-4 h-4 bg-default"}>
            <path 
